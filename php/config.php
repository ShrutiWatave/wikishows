<?php
    ...
    $makeTable = "CREATE TABLE IF NOT EXISTS signup(id int not null AUTO_INCREMENT UNIQUE,pname varchar(50) not null,email varchar(30) not null,pass varchar(30) not null,gender varchar(10) not null,contact varchar(20) not null,email_send varchar(5) not null);";
